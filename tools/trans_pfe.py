...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='/home/xiaohu/3D/OP/EasyPointPillars/tools/cfgs/kitti_models/pointpillar.yaml',
                        help='specify the config')
    parser.add_argument('--ckpt', type=str, default='/home/xiaohu/3D/OP/EasyPointPillars/tools/checkpoint_epoch_80.pth', 
                        help='specify the pretrained model')
    parser.add_argument('--output_path', type=str, default='/home/xiaohu/3D/OP/EasyPointPillars/tools/pfe.onnx', 
