...
def parse_config():
    ...
    parser.add_argument(
        '--save_to_file', action='store_true', default=True, help='')
...
def main():
    ...
    # /home/xiaohu/3D/OpenPCDet/output/kitti_models/pointpillar/default
    # cfg.ROOT_DIR: /home/xiaohu/3D/OpenPCDet
    # cfg.TAG: pointpillar
    # args.extra_tag 默认default
    output_dir = cfg.ROOT_DIR / 'output' / \
        cfg.EXP_GROUP_PATH / cfg.TAG / args.extra_tag
    output_dir.mkdir(parents=True, exist_ok=True)
    # /home/xiaohu/3D/OpenPCDet/output/kitti_models/pointpillar/default/eval
    eval_output_dir = output_dir / 'eval'
    # 默认false
    if not args.eval_all:
        # re.findall()：函数返回包含所有匹配项的列表。返回string中所有与pattern相匹配的全部字串，返回形式为数组
        #  ckpt             models/pointpillar/default/ckpt/checkpoint_epoch_80.pth
        num_list = re.findall(
            r'\d+', args.ckpt) if args.ckpt is not None else []
        epoch_id = num_list[-1] if num_list.__len__() > 0 else 'no_number'
        # /home/xiaohu/3D/OpenPCDet/output/kitti_models/pointpillar/default/eval/epoch_80/val
    ...
    if args.eval_tag is not None:
        # /home/xiaohu/3D/OpenPCDet/output/kitti_models/pointpillar/default/eval/epoch_80/val/default
