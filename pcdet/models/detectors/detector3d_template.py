...
class Detector3DTemplate(nn.Module):
    ...
    def build_vfe(self, model_info_dict):
        ...
        # 获取模块生成的点特征维度
        model_info_dict['num_point_features'] = vfe_module.get_output_feature_dim() # 64
        # 将模块添加道module_list中
    ...
    def build_backbone_2d(self, model_info_dict):
        ...
        model_info_dict['num_bev_features'] = backbone_2d_module.num_bev_features # 384
    ...
    def build_dense_head(self, model_info_dict):
        ...
        dense_head_module = dense_heads.__all__[self.model_cfg.DENSE_HEAD.NAME](
            ...
            input_channels=model_info_dict['num_bev_features'], # 384 
    ...
    def _load_state_dict(self, model_state_disk, *, strict=True):
        # state_dict()就是状态字典（把模型的参数保存到一个对象里面）
    ...
    def load_params_from_file(self, filename, logger, to_cpu=False):
        ...
        # ../output/kitti_models/pointpillar/default/ckpt/checkpoint_epoch_80.pth to GPU
        ...
        if version is not None:
            # ==> Checkpoint trained from version: pcdet+0.3.0+19b7bf5
