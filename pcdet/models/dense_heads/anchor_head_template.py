...
class AnchorHeadTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, class_names, grid_size, point_cloud_range, predict_boxes_when_training):
        ...
        self.box_coder = getattr(box_coder_utils, anchor_target_cfg.BOX_CODER)( # pcdet.utils.box_coder_utils.ResidualCoder
            num_dir_bins=anchor_target_cfg.get('NUM_DIR_BINS', 6), # UM_DIR_BINS: 6
    ...
    def generate_anchors(anchor_generator_cfg, grid_size, point_cloud_range, anchor_ndim=7):
        ...
        # grid_size:[432,496,1]  config['feature_map_stride']:[2,2,2]
        # [[216,248],[216,248],[216,248]]
        feature_map_size = [grid_size[:2] // config['feature_map_stride'] for config in anchor_generator_cfg] 
        # list:3 [(1，248，216，1，2，7），(1，248，216，1，2，7），(1，248，216，1，2，7）], [2,2,2]
        anchors_list, num_anchors_per_location_list = anchor_generator.generate_anchors(feature_map_size)

        if anchor_ndim != 7: # 如果anchor的维度不等于7，则补0
    ...
    def get_target_assigner(self, anchor_target_cfg):
        ...
        if anchor_target_cfg.NAME == 'ATSS':
            ...
            target_assigner = AxisAlignedTargetAssigner(
                ...
                class_names=self.class_names, # ['Car','Pedestrian','Cyclist']
                box_coder=self.box_coder, # ResidualCoder
