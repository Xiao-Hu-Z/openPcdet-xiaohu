...
class AnchorGenerator(object):
    ...
    def generate_anchors(self, grid_sizes):
        ...
        for grid_size, anchor_size, anchor_rotation, anchor_height, align_center in zip(
            ...
            x_shifts, y_shifts, z_shifts = torch.meshgrid([x_shifts, y_shifts, z_shifts])  # [x_grid, y_grid, z_grid] torch.Size([216, 248, 1]) torch.Size([216, 248, 1]) torch.Size([216, 248, 1])
...
if __name__ == '__main__':
    ...
    import pdb
    pdb.set_trace()
    A.generate_anchors([[216,248],[216,248],[216,248]])
