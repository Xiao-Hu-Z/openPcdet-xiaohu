...
/*
g_odata   : 实参dev_cumsum_along_x
g_idata   : 实参dev_sparse_pillar_map
n         : 实参num_inds_for_scan_
*/
{
  ...
  int offset = 1;
  // 稀疏特征图
  temp[2 * thid] = g_idata[bid * bdim * 2 + 2 * thid];  // 加载数据到共享内存
...
num_anchor_: 468 * 468 * 6 候选框数，head部分
min_x_range_: -74.88f
min_y_range_: -74.88f
pillar_x_size_:  0.32
pillar_y_size_: 0.32
